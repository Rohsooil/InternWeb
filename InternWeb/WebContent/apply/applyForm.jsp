			...
			<form action="/rlhvote/apply/application" accept-charset="UTF-8" method="post">
				...
				<div class="table">
					...
					<div class="t_row">
						...
						<div class="t_content" style="flex: 1.5">
							<span><myTag:phoneInputForm type="tel" id="apart_tel"/></span>
						</div>
						<div class="t_title" style="flex: 1">
							<span>팩스</span>
						</div>
						<div class="t_content" style="flex: 1.5">
							<span><myTag:phoneInputForm type="tel" id="apart_fax"/></span>
						</div>
					</div>
					<div class="t_row">
						<div class="t_title">
						...
						<div class="t_content">
							<span><input type="text" name="apart_address" value="${requestScope.apart.address}"></span>
						</div>
					</div>
				</div>
				<br>
				...
				<div class="table">
					...
					<div class="t_row">
						...
						<div class="t_content" style="flex: 1.5">
							<span><input type="text" name="admin_name" value="${requestScope.admin.name}"></span>
						</div>
						<div class="t_title" style="flex: 1">
							<span>직위</span>
						</div>
						<div class="t_content" style="flex: 1.5">
							<span><input type="text" name="admin_rank" value="${requestScope.admin.rank}"></span>
						</div>
					</div>
					<div class="t_row">
						<div class="t_title" style="flex: 1">
						...
						<div class="t_content" style="flex: 1.5">
							<span><myTag:phoneInputForm type="tel" id="admin_tel"/></span>
						</div>
						<div class="t_title" style="flex: 1">
							<span>연락처(무선)</span>
						</div>
						<div class="t_content" style="flex: 1.5">
							<span><myTag:phoneInputForm type="phone" id="admin_phone"/></span>
						</div>
					</div>
					<div class="t_row">
						<div class="t_title">
				...
				<div class="table">
					<div class="t_row">
						...
						<div class="t_content">
							<span><input type="text" name="vote_title" id="vote_title" value="${requestScope.vote.title}"></span>
						</div>
					</div>
					<div class="t_row">
						<div class="t_title">
					...
					<div class="t_row">
						...
						<div class="t_content">
							<span><input type="text" class="numberInput" name="vote_estimate" id="vote_estimate" value="${requestScope.vote.estimate}"></span>
						</div>
					</div>
					<div class="t_row">
						<div class="t_title">
					...
					<div class="t_row">
						...
						<div class="t_content">
							<span>
								<input type="checkbox" name="vote_media" id="pc" class="vote_media" value="1">
								<label for="pc">
									<span class="chk_box"></span>
									<span>PC(인터넷)</span>
								</label>
								<input type="checkbox" name="vote_media" id="phone" class="vote_media" value="2">
								<label for="phone">
									<span class="chk_box"></span>
									<span>스마트폰(인터넷)</span>
								</label>
								<input type="checkbox" name="vote_media" id="sms" class="vote_media" value="3">
								<label for="sms">
									<span class="chk_box"></span>
									<span>문자투표</span>
								</label>
								<input type="checkbox" name="vote_media" id="place" class="vote_media" value="4">
								<label for="place">
									<span class="chk_box"></span>
									<span>현장투표소</span>
								</label>
